...
$("#studioForm").onsubmit=e=>{e.preventDefault();const fd=new FormData(e.currentTarget);data.studio=Object.fromEntries(fd.entries());save();toast("Información del estudio guardada.")}
